...
(function() {
  ...
  describe('K Nearest Neighbor with distance flag', function() {
    var getLabels;
    ...
    describe('with basic testCase', function() {
      ...
      it('should return the nearest neighbor', function() {
        knn(profile1, objects, {
          distFlag: true
        })[0].obj.label.should.eql('C');
        knn(profile2, objects, {
          distFlag: true
        })[0].obj.label.should.eql('E');
        return knn(profile3, objects, {
          distFlag: true
        })[0].obj.label.should.eql('J');
      });
